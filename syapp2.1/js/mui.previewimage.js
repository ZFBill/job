(function($, window) {
	...
	proto.addImage = function(img) {
		...
		if (img.__mui_img_data && img.__mui_img_data.src === src) { //宸茬紦瀛樹笖鍥剧墖鏈彉鍖�
	...
	proto._loadItem = function(index, isOpening) { //TODO 鏆傛椂浠呮敮鎸乮mg
	...
	proto.open = function(index, group) {
		...
		if (typeof index === "number") {
			group = group || defaultGroupName;
			this.addImages(group, index); //鍒锋柊褰撳墠group
